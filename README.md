...
### Read these notes carefully before proceeding 
 - Edit any mentions of @InfinityJE to your own support chat
 - Your code must be open source and a link to your fork's repository must be there in the start reply of the bot [See this](https://github.com/AnimeKaizoku/LaraCroftRobot/blob/shiken/LaraCroftRobot/__main__.py#L25)
...
This file should be placed in your `LaraCroftRobot` folder, alongside the `__main__.py` file. 
...
```
from LaraCroftRobot.sample_config import Config
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ImJanindu/NarutoRobot.git) 
...
Should any be missing kindly let us know at [Naruto Support](https://t.me/Infinity_BOTs) or simply submit a pull request on the readme.
