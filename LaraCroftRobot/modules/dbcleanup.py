...
import LaraCroftRobot.modules.sql.global_bans_sql as gban_sql
import LaraCroftRobot.modules.sql.users_sql as user_sql
from LaraCroftRobot import DEV_USERS, OWNER_ID, dispatcher
